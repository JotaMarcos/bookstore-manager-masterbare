...
O projeto foi desenvolvido como base de criação do curso introdutório sobre Spring Boot, o projeto foi concluído e personalizado por João Marcos Aires Duarte.
...
```
https://dashboard.heroku.com/apps/bookstore-manager-masterbare
```
